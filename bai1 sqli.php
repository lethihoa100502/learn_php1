...
VALUES
('1','Hòa 1', 'hoa1@example.com', '1111111111'),
('2','Hòa 2', 'hoa2@example.com', '2222222222'),
('3','Hòa 3', 'hoa3@example.com', '3333333333'),
('4','Hòa 4', 'hoa4@example.com', '4444444444'),
('5','Hòa 5', 'hoa5@example.com', '5555555555')";
$result = mysqli_query($dbh,$sql_stmt);
if (!$result){
...
SET name = 'Hòa 6', email = 'hoa6@example.com', phone = '887654321'
WHERE ID = 1";
$result = mysqli_query($dbh,$sql_stmt);
if (!$result){
